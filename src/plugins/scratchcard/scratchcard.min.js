!(function (t, n) {
  ...
  return (function (t) {
    ...
    function (t, n, e) {
      t.exports =
        ...
        !e(15)(function () {
          return (
            7 !=
            Object.defineProperty(e(22)("div"), "a", {
              get: function () {
                return 7;
              }
            }).a
    ...
    function (t, n, e) {
      ...
      t.exports =
        ...
        e(15)(function () {
          ...
          ? function (t, n) {
              for (
                var e = c(t), s = arguments.length, u = 1, f = o.f, h = i.f;
                s > u;
    ...
    function (t, n, e) {
      var r = e(12);
      r(r.P, "Array", { fill: e(62) }), e(63)("fill");
    },
    function (t, n, e) {
      "use strict";
      var r = e(32),
            ...
            },
            {
              ...
              value: function (t) {
                var n = t,
                  ...
                  o = 2 * Math.random() * r - r;
                return (
                  (e += n), (o += n), [(e += this.mouseX), (o += this.mouseY)]
                );
              }
            },
            {
              ...
              value: function (t) {
                if (null !== t) {
                  ...
                  this.ctx.save(),
                    ...
                    // retina螢幕時containerWidth和containerHeight要設成2倍 圖片才不會糊掉
                    // ↓並把brush的xy座標設為2倍 刮除時座標才不會出錯
                    this.ctx.translate(this.mouseX * 2, this.mouseY * 2),
      ...
      var h = (function () {
        function t(n, e) {
          ...
          (this.config = Object.assign({}, a, e)),
            ...
            (this.brush = new f(this.ctx, this.position[0], this.position[1])),
            this.config.scratchType === r.BRUSH &&
              s(this.config.brushSrc).then(function (t) {
                o.brushImage = t;
              });
          var h = u(function (t) {
            t.preventDefault(),
          ...
          a()(t, [
            ...
            },
            {
              ...
              value: function () {
                var t = this;
                return new Promise(function (n, e) {
                  s(t.config.imageForwardSrc).then(
                    function (e) {
                      (t.scratchImage = e),
                        t.ctx.drawImage(
                          t.scratchImage,
            ...
            },
            {
              ...
              value: function () {
                ...
                if (0 !== this.config.htmlBackground.length)
                  ...
                  s(this.config.imageBackgroundSrc).then(
                    function (e) {
